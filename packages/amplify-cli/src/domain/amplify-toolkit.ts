...
export class AmplifyToolkit {
  ...
  get constructExeInfo(): any {
    this._constructExeInfo = this._constructExeInfo || require(path.join(this._amplifyHelpersDirPath, 'construct-exeInfo')).constructExeInfo;
  ...
  get executeProviderUtils(): any {
    this._executeProviderUtils = this._executeProviderUtils || require(path.join(this._amplifyHelpersDirPath, 'execute-provider-utils')).executeProviderUtils;
  ...
  get getCategoryPluginInfo(): any {
    this._getCategoryPluginInfo = this._getCategoryPluginInfo || require(path.join(this._amplifyHelpersDirPath, 'get-category-pluginInfo')).getCategoryPluginInfo;
  ...
  get getAllCategoryPluginInfo(): any {
    this._getAllCategoryPluginInfo = this._getAllCategoryPluginInfo
  ...
  get getFrontendPlugins(): any {
    this._getFrontendPlugins = this._getFrontendPlugins || require(path.join(this._amplifyHelpersDirPath, 'get-frontend-plugins')).getFrontendPlugins;
  ...
  get getProviderPlugins(): any {
    this._getProviderPlugins = this._getProviderPlugins || require(path.join(this._amplifyHelpersDirPath, 'get-provider-plugins')).getProviderPlugins;
  ...
  get getPluginInstance(): any {
    this._getPluginInstance = this._getPluginInstance || require(path.join(this._amplifyHelpersDirPath, 'get-plugin-instance')).getPluginInstance;
  ...
  get getProjectConfig(): any {
    this._getProjectConfig = this._getProjectConfig || require(path.join(this._amplifyHelpersDirPath, 'get-project-config')).getProjectConfig;
  ...
  get getProjectDetails(): () => $TSAny {
    this._getProjectDetails = this._getProjectDetails || require(path.join(this._amplifyHelpersDirPath, 'get-project-details')).getProjectDetails;
  ...
  get getResourceStatus(): any {
    this._getResourceStatus = this._getResourceStatus || require(path.join(this._amplifyHelpersDirPath, 'resource-status')).getResourceStatus;
  ...
  get getResourceOutputs(): any {
    this._getResourceOutputs = this._getResourceOutputs || require(path.join(this._amplifyHelpersDirPath, 'get-resource-outputs')).getResourceOutputs;
  ...
  get storeCurrentCloudBackend(): any {
    this._storeCurrentCloudBackend = this._storeCurrentCloudBackend || require(path.join(this._amplifyHelpersDirPath, 'push-resources')).storeCurrentCloudBackend;
  ...
  get serviceSelectionPrompt(): any {
    this._serviceSelectionPrompt = this._serviceSelectionPrompt || require(path.join(this._amplifyHelpersDirPath, 'service-select-prompt')).serviceSelectionPrompt;
  ...
  get updateProjectConfig(): any {
    this._updateProjectConfig = this._updateProjectConfig || require(path.join(this._amplifyHelpersDirPath, 'update-project-config')).updateProjectConfig;
  ...
  get updateProvideramplifyMeta(): any {
    this._updateProvideramplifyMeta = this._updateProvideramplifyMeta || require(path.join(this._amplifyHelpersDirPath, 'update-amplify-meta')).updateProvideramplifyMeta;
  ...
  get updateamplifyMetaAfterPush(): any {
    this._updateamplifyMetaAfterPush = this._updateamplifyMetaAfterPush || require(path.join(this._amplifyHelpersDirPath, 'update-amplify-meta')).updateamplifyMetaAfterPush;
  ...
  get updateBackendConfigAfterResourceUpdate(): any {
    this._updateBackendConfigAfterResourceUpdate = this._updateBackendConfigAfterResourceUpdate
  ...
  get loadEnvResourceParameters(): any {
    this._loadEnvResourceParameters = this._loadEnvResourceParameters || require(path.join(this._amplifyHelpersDirPath, 'envResourceParams')).loadEnvResourceParameters;
  ...
  get removeDeploymentSecrets(): any {
    this._removeDeploymentSecrets = this._removeDeploymentSecrets || require(path.join(this._amplifyHelpersDirPath, 'envResourceParams')).removeDeploymentSecrets;
  ...
  get deleteDeselectedTriggers(): any {
    this._deleteDeselectedTriggers = this._deleteDeselectedTriggers || require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).deleteDeselectedTriggers;
  ...
  get getTriggerMetadata(): any {
    this._getTriggerMetadata = this._getTriggerMetadata || require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).getTriggerMetadata;
  ...
  get getTriggerEnvVariables(): any {
    this._getTriggerEnvVariables = this._getTriggerEnvVariables || require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).getTriggerEnvVariables;
  ...
  get getTriggerEnvInputs(): any {
    this._getTriggerEnvInputs = this._getTriggerEnvInputs || require(path.join(this._amplifyHelpersDirPath, 'trigger-flow')).getTriggerEnvInputs;
  ...
  get getUserPoolGroupList(): any {
    this._getUserPoolGroupList = this._getUserPoolGroupList || require(path.join(this._amplifyHelpersDirPath, 'get-userpoolgroup-list')).getUserPoolGroupList;
  ...
  get forceRemoveResource(): any {
    this._forceRemoveResource = this._forceRemoveResource || require(path.join(this._amplifyHelpersDirPath, 'remove-resource')).forceRemoveResource;
  ...
  get writeObjectAsJson(): any {
    this._writeObjectAsJson = this._writeObjectAsJson || require(path.join(this._amplifyHelpersDirPath, 'write-object-as-json')).writeObjectAsJson;
  ...
  get leaveBreadcrumbs(): any {
    this._leaveBreadcrumbs = this._leaveBreadcrumbs || require(path.join(this._amplifyHelpersDirPath, 'leave-breadcrumbs')).leaveBreadcrumbs;
  ...
  get loadRuntimePlugin(): any {
    this._loadRuntimePlugin = this._loadRuntimePlugin || require(path.join(this._amplifyHelpersDirPath, 'load-runtime-plugin')).loadRuntimePlugin;
  ...
  get getImportedAuthProperties(): any {
    this._getImportedAuthProperties = this._getImportedAuthProperties
  ...
  get invokePluginMethod(): any {
    this._invokePluginMethod = this._invokePluginMethod || require(path.join(this._amplifyHelpersDirPath, 'invoke-plugin-method')).invokePluginMethod;
